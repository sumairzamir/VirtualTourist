...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    /*
     The DataController is instantiated in this class rather than the AppDelegate.
     The DataControler is "injected" via dependency into the initial ViewController.
     */
    var window: UIWindow?
    
    // Definition and instantiation of the DataController from the DataController class.
